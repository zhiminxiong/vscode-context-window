...
const relationsTool: McpToolDefinition = {
    ...
    description: [
        ...
        'on the type’s ancestor chain; nearest this.method() on that chain, plus obj.method()',
        'receivers; sibling this.method() is omitted; this.xxx() callees resolve to the most-derived',
        'override on that same chain), skips arrow / <function> callers in favor of the enclosing',
        'named method, follows super calls, and marks recursion, which a text search cannot do.',

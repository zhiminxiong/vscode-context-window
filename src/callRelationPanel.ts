  ...
  <header class="cr-bar">
    ...
    <div class="cr-actions">
      ...
      <div class="cr-modes">
        ...
        <button type="button" id="cr-pin" class="cr-btn cr-icon-btn" title="Pin the current graph so cursor moves do not refresh it" aria-pressed="false" aria-label="Pin graph"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><g transform="rotate(90 12 12)"><path d="M12 17v5"/><path d="M9 10.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24V16h14v-.76a2 2 0 0 0-1.11-1.79l-1.78-.9A2 2 0 0 1 15 10.76V7a1 1 0 0 1 1-1 2 2 0 0 0 0-4H8a2 2 0 0 0 0 4 1 1 0 0 1 1 1z"/></g></svg></button>

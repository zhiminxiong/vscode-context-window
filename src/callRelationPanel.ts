  ...
  <header class="cr-bar">
    ...
    <div class="cr-actions">
      ...
      <div class="cr-modes">
        ...
        <button type="button" id="cr-pin" class="cr-btn cr-icon-btn" title="Pin the current graph so cursor moves do not refresh it" aria-pressed="false" aria-label="Pin graph"><svg viewBox="0 0 16 16" width="16" height="16" aria-hidden="true"><path fill="currentColor" d="M13.5 3C13.303 3 13.109 3.038 12.923 3.114L8.481 4.967L5.659 4.026C5.505 3.976 5.339 4.001 5.209 4.095C5.078 4.189 5.001 4.339 5.001 4.5V7H1.257L0.5 7.5L1.257 8H5V10.5C5 10.661 5.077 10.812 5.208 10.905C5.338 11 5.504 11.023 5.658 10.974L8.48 10.033L12.925 11.887C13.109 11.962 13.302 12 13.499 12C14.326 12 14.999 11.327 14.999 10.5V4.5C14.999 3.673 14.326 3 13.499 3H13.5ZM14 10.5C14 10.843 13.615 11.09 13.308 10.962L8.693 9.038C8.631 9.013 8.566 9 8.501 9C8.447 9 8.395 9.009 8.343 9.025L6.001 9.806V5.193L8.343 5.974C8.457 6.011 8.581 6.007 8.694 5.961L13.306 4.038C13.629 3.902 14.001 4.156 14.001 4.499V10.499L14 10.5Z"/></svg></button>
        <div class="cr-slim-wrap" id="cr-slim-wrap">
          <button type="button" id="cr-slim" class="cr-btn cr-icon-btn" title="Slim filter off — show every symbol the language server returns" aria-pressed="false" aria-label="Slim filter"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg></button>
          <button type="button" id="cr-slim-kinds" class="cr-btn cr-slim-caret" title="Kinds kept when Slim is on" aria-haspopup="true" aria-expanded="false" aria-label="Slim kinds"></button>
        </div>
        <button type="button" id="cr-jump-trail" class="cr-btn cr-icon-btn is-on" title="Jump trail on — hide the center path at the top" aria-pressed="true" aria-label="Hide jump trail"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="6" cy="19" r="3"/><path d="M9 19h8.5a3.5 3.5 0 0 0 0-7h-11a3.5 3.5 0 0 1 0-7H15"/><circle cx="18" cy="5" r="3"/></svg></button>
        <button type="button" id="cr-tips" class="cr-btn cr-icon-btn is-on" title="Tips on — hover to show. Click to show only while holding Alt." aria-pressed="true" aria-label="Node tips on"><svg viewBox="0 0 16 16" width="16" height="16" aria-hidden="true"><path fill="currentColor" d="M14.5 2h-13l-.5.5v9l.5.5H4v2.5l.854.146L7.207 12H14.5l.5-.5v-9l-.5-.5zm-.5 9H6.793L5 12.793V11H2V3h12v8z"/></svg></button>

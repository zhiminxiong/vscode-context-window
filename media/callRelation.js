...
const THUMB_PIN = '<circle cx="8" cy="3.85" r="2.1"/><path d="M8 6v8"/>';
const ICON_PIN = `<svg viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.15" stroke-linecap="round" aria-hidden="true"><g transform="rotate(90 8 8)">${THUMB_PIN}</g></svg>`;
const ICON_PINNED = `<svg viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.15" stroke-linecap="round" aria-hidden="true">${THUMB_PIN}</svg>`;
